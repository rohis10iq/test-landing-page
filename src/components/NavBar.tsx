  ...
  return (
    <header className="text-gray-600 body-font bg-gray-200">
      <div className="container mx-auto flex flex-wrap flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0 ml-6">
          <img
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          ...
          <a className="mr-10 hover:text-gray-900">Undergraduate</a>
          <a className="mr-10 hover:text-gray-900">Graduate</a>
          <a className="mr-10 hover:text-gray-900">Short Courses</a>
          <a className="mr-10 hover:text-gray-900">Hostels</a>
          <a className="mr-10 hover:text-gray-900">Internships Jobs</a>
        </nav>
        <div className="flex items-center">
          ...
          <button className="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base ml-10">
            Sign In
          </button>
          <button>
          <FaUser className="w-4 h-4 ml-4 mr-10" />
          </button>
        </div>
      </div>
    </header>
